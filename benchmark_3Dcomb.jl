...
elseif "nn" in ARGS
	include("algorithms/nn_algo.jl")	# it sucks, probably dont include it
elseif "star" in ARGS
...
rob_p = "/3Dcomb/robot.obj"
env_p = "/3Dcomb/env.obj"
gol_p = "/3Dcomb/goal.obj"
prb_p = "/probe.obj"
...
fac         	= 2.5
iterations	= 100000
name		= "3Dcomb/"*string(ARGS[1])	# NO FIRST SLASH!
...
# or manually chose the bounds
# x_min, x_max, y_min, y_max, z_min, z_max =   -1, 30,  -12,  21, -8,    8)  # knot environment
