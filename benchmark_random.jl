...
rob_p = "/random/robot.obj"
env_p = "/random/environment.obj"
gol_p = "/random/goal.obj"
prb_p = "/probe.obj"
...
fac         	= 2.5
iterations	= 100000
name		= "random/"*string(ARGS[1])	# NO FIRST SLASH!
...
x_min, x_max, y_min, y_max, z_min, z_max = get_bounds(obstacles)
