...
def create_animation():
    ...
    #imported_object = bpy.ops.import_scene.dae(filepath="/home/krizjona/Project/meshes/ompl/complex_env.dae")
    imported_object = bpy.ops.wm.collada_import(filepath="/home/krizjona/Project/meshes/opt/curved_env.dae")
    obj_object = bpy.context.selected_objects[0]
    #obj_object.rotation_euler = (0, 0, 0)

    #imported_object = bpy.ops.import_scene.dae(filepath="/home/krizjona/Project/meshes/ompl/complex_rob.dae")
    imported_object = bpy.ops.wm.collada_import(filepath="/home/krizjona/Project/meshes/opt/robot.dae")
    obj_object = bpy.context.selected_objects[0]
    #obj_object.rotation_euler = (0, 0, 0)
    ...
    # Create animation
    frame_no = 0
    with open("/home/krizjona/Project/ompl/benchmark/easy/easy_env_big_geometric_RRTstar_0.path", "r") as path:
        for step in path:
            ...
            #obj_object.rotation_quaternion = (step[6], step[5], step[4], step[3])        
            #obj_object.keyframe_insert(data_path="rotation_quaternion", index=-1)

            # Position
            obj_object.location = (step[0], -step[2], step[1])
